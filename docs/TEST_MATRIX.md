...
| **TM-07** | Postman Collection | Import `postman/BidSure.postman_collection.json` into Postman | Collection imports validly with pre-configured endpoints | **PASS** |
| **TM-08** | Secret Protection | Audit `.gitignore` and git staged files | No `.env` or credential files committed | **PASS** |
